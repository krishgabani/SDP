  ...
  return (
    <> 
      ...
      >
        ...
        <Modal.Body>
          <Form>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>Sr No</Form.Label><Form.Control type="text" defaultValue={newData.Sr_No} /></Form.Group>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>Publication Type</Form.Label><Form.Control type="text" name="Publication_Type" value={newData.Publication_Type} defaultValue={newData.Publication_Type} onChange={handleChange} /></Form.Group>
