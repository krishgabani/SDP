...
const EditModalConference = (props) => {
      ...
      >
        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>Publication Type</Form.Label><Form.Control type="text" name="Publication_Type" value={newData.Publication_Type} defaultValue={props.data.Publication_Type} onChange={handleChange} /></Form.Group>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>Title of the conference</Form.Label><Form.Control type="text" name="Title_of_the_conference" value={newData.Title_of_the_conference} defaultValue={props.data.Title_of_the_conference} onChange={handleChange} /></Form.Group>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>Start Date (DD-MM-YYYY)</Form.Label><Form.Control type="text" name="Start_Date_DD_MM_YYYY" value={newData.Start_Date_DD_MM_YYYY} defaultValue={props.data.Start_Date_DD_MM_YYYY} onChange={handleChange} /></Form.Group>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>End Date (DD-MM-YYYY)</Form.Label><Form.Control type="text" name="End_Date_DD_MM_YYYY" value={newData.End_Date_DD_MM_YYYY} defaultValue={props.data.End_Date_DD_MM_YYYY} onChange={handleChange} /></Form.Group>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>Conference Name</Form.Label><Form.Control type="text" name="Conference_Name" value={newData.Conference_Name} defaultValue={props.data.Conference_Name} onChange={handleChange} /></Form.Group>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>Conference Organizer</Form.Label><Form.Control type="text" name="Conference_Organizer" value={newData.Conference_Organizer} defaultValue={props.data.Conference_Organizer} onChange={handleChange} /></Form.Group>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>Conference City</Form.Label><Form.Control type="text" name="Conference_City" value={newData.Conference_City} defaultValue={props.data.Conference_City} onChange={handleChange} /></Form.Group>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>Conference State</Form.Label><Form.Control type="text" name="Conference_State" value={newData.Conference_State} defaultValue={props.data.Conference_State} onChange={handleChange} /></Form.Group>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>Conference Country</Form.Label><Form.Control type="text" name="Conference_Country" value={newData.Conference_Country} defaultValue={props.data.Conference_Country} onChange={handleChange} /></Form.Group>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>Name of the Publisher</Form.Label><Form.Control type="text" name="Name_of_the_Publisher" value={newData.Name_of_the_Publisher} defaultValue={props.data.Name_of_the_Publisher} onChange={handleChange} /></Form.Group>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>ISBN or ISSN</Form.Label><Form.Control type="text" name="ISBN_or_ISSN" value={newData.ISBN_or_ISSN} defaultValue={props.data.ISBN_or_ISSN} onChange={handleChange} /></Form.Group>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1"><Form.Label>Affiliating Institute at the time of publication</Form.Label><Form.Control type="text" name="Affiliating_Institute_at_the_time_of_publication" value={newData.Affiliating_Institute_at_the_time_of_publication} defaultValue={props.data.Affiliating_Institute_at_the_time_of_publication} onChange={handleChange} /></Form.Group>
          </Form>
        </Modal.Body>
        <Modal.Footer>
